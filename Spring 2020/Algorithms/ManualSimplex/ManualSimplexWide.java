...
public class ManualSimplexWide extends Basic
{

//==================================================================================================
  // NOTE:  edit these constants appropriately to adjust for different displays
  
  // total size of the window in pixels (standard is 1010 by 700
  private static final int pixelWidth = 2000, pixelHeight = 1000;  // total window size in pixels
...
//==================================================================================================
  ...
  public static void main(String[] args)
  {
    ...
    ManualSimplexWide ms = new ManualSimplexWide("Manual Simplex Method Tool", 0, 0, pixelWidth, pixelHeight, fname );
  }
  ...
  public ManualSimplexWide( String title, int ulx, int uly, int pw, int ph, 
                          String fname )
  {

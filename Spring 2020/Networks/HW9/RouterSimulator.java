...
public class RouterSimulator {
   public static void main(String[] args) throws IOException{
      ...
      Hashtable<Integer, Integer> Y = new Hashtable<Integer, Integer>();  // Connecting paths      
      ...
      for (int item: Y.keySet()) {
            System.out.println("{V"+ Y.get(item) + ", V" + item + "}");   
      }
